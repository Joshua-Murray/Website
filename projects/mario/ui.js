...
function setCheats() {
  ...
  console.log("There's not really any way to stop you from messing around so if you'd like to know if there is any common cheats.");
  console.log("Well you will not have any because.....");
  console.log("there is no cheats working.");
  window.cheats = {
